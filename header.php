...
<html lang="en">
  ...
  <body style="font-family: bahnschrift; background-image: url('assets/Animated Shape.svg')">
  ...
  <div class="container-fluid" style="margin-left: 1%;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link disabled">Assignment</a>
        </li>
      </ul>

    <!-- ========== Start login & sign up buttons ========== -->

    <a style="text-decoration: none;" data-bs-toggle="modal" data-bs-target="#loginModal" type="button">

      <button1 style="background-color: black; margin-right: 5%; max-width: fit-content;" >
